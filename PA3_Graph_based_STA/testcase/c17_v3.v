module c17_v3 (N1, N2, N3, N4, N5, N6, N7, N8, N9, N10,N30, N31, N32, N33, N34, N35, N36, N37);
...
/*wqeqwe 879n qweq we */
    ...
    NOR2X1 U2 (.A1(N3), .A2(N4), .ZN(n12));///*wqeqwe 879n qweq we */
...
/*wqeqwe 879n qweq we */
    ...
    NANDX1 U7 (.A1(n11), .A2(n12), .ZN(n17));//*wqeqwe 879n qweq we */
    ...
    NANDX1 U17 (.A1(n25), .A2(n26), .ZN(n27));//wqeqwe 879n qweq we */
