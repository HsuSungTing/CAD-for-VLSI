...
void build_index_vec(struct liberty_file &file, vector<vector<string>> result){
    ...
    for(size_t i=0;i<index_1_results.size();i++){
        file.index_1.push_back(index_1_results[i]);
    }
    for(size_t i=0;i<index_2_results.size();i++){
...
void build_NAND_TB(struct liberty_file &file, vector<string> result){
    ...
    for(size_t i=0;i<gate_results.size();i++){
        for(size_t j=1;j<gate_results[i].size()-1;j++){
...
void show_liberty_file(struct liberty_file file){ //for debug
    cout<<"index 1: "<<endl;
    for(size_t i=0;i<file.index_1.size();i++){
        cout<<file.index_1[i]<<" ";
    }
    cout<<endl;
    cout<<"index 2: "<<endl;
    for(size_t i=0;i<file.index_2.size();i++){
        cout<<file.index_2[i]<<" ";
    }
    cout<<endl;
    ...
    for(size_t i=0;i<file.NOR.cell_rise_TB.size();i++){
        for(size_t j=0;j<file.NOR.cell_rise_TB[i].size();j++){
            cout<<file.NOR.cell_rise_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.NOR.cell_fall_TB: "<<endl;
    for(size_t i=0;i<file.NOR.cell_fall_TB.size();i++){
        for(size_t j=0;j<file.NOR.cell_fall_TB[i].size();j++){
            cout<<file.NOR.cell_fall_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.NOR.rise_transision_TB: "<<endl;
    for(size_t i=0;i<file.NOR.rise_transision_TB.size();i++){
        for(size_t j=0;j<file.NOR.rise_transision_TB[i].size();j++){
            cout<<file.NOR.rise_transision_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.NOR.fall_transision_TB: "<<endl;
    for(size_t i=0;i<file.NOR.fall_transision_TB.size();i++){
        for(size_t j=0;j<file.NOR.fall_transision_TB[i].size();j++){
    ...
    for(size_t i=0;i<file.INV.cell_rise_TB.size();i++){
        for(size_t j=0;j<file.INV.cell_rise_TB[i].size();j++){
            cout<<file.INV.cell_rise_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.INV.cell_fall_TB: "<<endl;
    for(size_t i=0;i<file.INV.cell_fall_TB.size();i++){
        for(size_t j=0;j<file.INV.cell_fall_TB[i].size();j++){
            cout<<file.INV.cell_fall_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.INV.rise_transision_TB: "<<endl;
    for(size_t i=0;i<file.INV.rise_transision_TB.size();i++){
        for(size_t j=0;j<file.INV.rise_transision_TB[i].size();j++){
            cout<<file.INV.rise_transision_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.INV.fall_transision_TB: "<<endl;
    for(size_t i=0;i<file.INV.fall_transision_TB.size();i++){
        for(size_t j=0;j<file.INV.fall_transision_TB[i].size();j++){
    ...
    for(size_t i=0;i<file.NAND.cell_rise_TB.size();i++){
        for(size_t j=0;j<file.NAND.cell_rise_TB[i].size();j++){
            cout<<file.NAND.cell_rise_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.NAND.cell_fall_TB: "<<endl;
    for(size_t i=0;i<file.NAND.cell_fall_TB.size();i++){
        for(size_t j=0;j<file.NAND.cell_fall_TB[i].size();j++){
            cout<<file.NAND.cell_fall_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.NAND.rise_transision_TB: "<<endl;
    for(size_t i=0;i<file.NAND.rise_transision_TB.size();i++){
        for(size_t j=0;j<file.NAND.rise_transision_TB[i].size();j++){
            cout<<file.NAND.rise_transision_TB[i][j]<<" ";
        }
        cout<<endl;
    }
    cout<<"file.NAND.fall_transision_TB: "<<endl;
    for(size_t i=0;i<file.NAND.fall_transision_TB.size();i++){
        for(size_t j=0;j<file.NAND.fall_transision_TB[i].size();j++){
