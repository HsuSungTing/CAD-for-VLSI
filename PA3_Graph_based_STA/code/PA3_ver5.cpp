...
void find_result_from_TB(string gate_type,double input_transition,double load_capacitance,struct liberty_file file,double &cell_rise,double &cell_fall,double &rise_transition,double &fall_transition){
    ...
    double x0, x1, y0, y1, f_0_0, f_1_0, f_0_1, f_1_1;
    if(gate_type=="INVX1"){
        f_0_0=file.INV.cell_rise_TB[var2_lower_idx][var1_lower_idx];
        f_1_0=file.INV.cell_rise_TB[var2_lower_idx][var1_upper_idx];
        f_0_1=file.INV.cell_rise_TB[var2_upper_idx][var1_lower_idx];
        f_1_1=file.INV.cell_rise_TB[var2_upper_idx][var1_upper_idx];
        ...
        f_0_0=file.INV.cell_fall_TB[var2_lower_idx][var1_lower_idx];
        f_1_0=file.INV.cell_fall_TB[var2_lower_idx][var1_upper_idx];
        f_0_1=file.INV.cell_fall_TB[var2_upper_idx][var1_lower_idx];
        f_1_1=file.INV.cell_fall_TB[var2_upper_idx][var1_upper_idx];
        ...
        f_0_0=file.NAND.cell_rise_TB[var2_lower_idx][var1_lower_idx];
        f_1_0=file.NAND.cell_rise_TB[var2_lower_idx][var1_upper_idx];
        f_0_1=file.NAND.cell_rise_TB[var2_upper_idx][var1_lower_idx];
        f_1_1=file.NAND.cell_rise_TB[var2_upper_idx][var1_upper_idx];
        cell_rise=bilinear_interpolation(load_capacitance,input_transition, var1_lower,var1_upper, var2_lower,var2_upper,f_0_0,f_1_0,f_0_1,f_1_1);
        
        f_0_0=file.NAND.cell_fall_TB[var2_lower_idx][var1_lower_idx];
        f_1_0=file.NAND.cell_fall_TB[var2_lower_idx][var1_upper_idx];
        f_0_1=file.NAND.cell_fall_TB[var2_upper_idx][var1_lower_idx];
        f_1_1=file.NAND.cell_fall_TB[var2_upper_idx][var1_upper_idx];
        cell_fall=bilinear_interpolation(load_capacitance,input_transition, var1_lower,var1_upper, var2_lower,var2_upper,f_0_0,f_1_0,f_0_1,f_1_1);
    }
    else if(gate_type=="NOR2X1"){
        f_0_0=file.NOR.cell_rise_TB[var2_lower_idx][var1_lower_idx];
        f_1_0=file.NOR.cell_rise_TB[var2_lower_idx][var1_upper_idx];
        f_0_1=file.NOR.cell_rise_TB[var2_upper_idx][var1_lower_idx];
        f_1_1=file.NOR.cell_rise_TB[var2_upper_idx][var1_upper_idx];
        cell_rise=bilinear_interpolation(load_capacitance,input_transition, var1_lower,var1_upper, var2_lower,var2_upper,f_0_0,f_1_0,f_0_1,f_1_1);
        
        f_0_0=file.NOR.cell_fall_TB[var2_lower_idx][var1_lower_idx];
        f_1_0=file.NOR.cell_fall_TB[var2_lower_idx][var1_upper_idx];
        f_0_1=file.NOR.cell_fall_TB[var2_upper_idx][var1_lower_idx];
        f_1_1=file.NOR.cell_fall_TB[var2_upper_idx][var1_upper_idx];
        cell_fall=bilinear_interpolation(load_capacitance,input_transition, var1_lower,var1_upper, var2_lower,var2_upper,f_0_0,f_1_0,f_0_1,f_1_1);
    }
}
...
void find_output_transition_and_delay(gate_node* node,struct liberty_file file){
    if(node->in_degree==0){
        ...
        cout<<"gate name: "<<node->name<<" cell_rise: "<<cell_rise<<" cell_fall: "<<cell_fall<<endl;
    }
}
