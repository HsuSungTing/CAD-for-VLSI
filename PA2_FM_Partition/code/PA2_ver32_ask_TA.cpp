...
void Fiduccia_Mattheyses(unordered_map<int,struct cell_node>cell_set,unordered_map<int,struct net_node>net_set,string output_file_name){
    ...
    while(1){
        ...
        while(1){
            ...
            inner_loop_counter++;
            if(inner_loop_counter%5==0) write_file(output_file_name, cur_best_cutsize,  cur_best_partition);
...
int main(int argc, char *argv[]){
    ...
    Fiduccia_Mattheyses(cell_set,net_set,output_file_name);
